...
const Sidebar = () => {
  ...
  return ( <div className="min-h-[100vh] inline-flex flex-col justify-between bg-bgSecondaryColor py-6 px-4">
    <div>
      <Menu
      size={25} 
      ...
      {isOpen ? (
        ...
        {prevPrompts?.map((item,index)=>(
           ...
           className="flex items-center gap-2.5 pr-10 rounded-full text-gray-700 cursor-pointer hover::bg-slate-200 p-2 bg-bgPrimaryColor">
         <MessageSquare 
         size={25} 
         className="cursor-pointer text-softTextColor" 
         />
    ...
    <div className="flex flex-col gap-5">
      <div className="pr-2.5 cursor-pointer flex gap-2 text-gray-400">
