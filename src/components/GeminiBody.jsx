...
import { CircleUserRound, Code, Compass, Lightbulb, SendHorizontal, Youtube } from 'lucide-react';
  ...
  return (
    <div className="flex-1 min-h-[100vh] pb-[15vh] relative">
      ...
      <div className="max-w-[900px] m-auto">
        {!displayResult ? (
        <>
        <div className="m-12 text-5xl font-medium p-5">
          <p>
        ...
        <div className="grid grid-cols-4 gap-5 p-5">
          <div className="h-48 p-4 bg-bgSecondaryColor rounded-xl relative cursor-pointer">
            <p>Suggest beautiful placess to see on an upcoming road trip</p>
            <Compass 
            size={35} 
        ...
        <p>{recentPrompts}</p>
          ...
          <div className="f;ex items-start gap-5">
            <img src="/gemini.png" alt="" />
            <p className="text-md font-normal loading-6 text-gray-400"
        ...
        <form action={submit}>
  <div className="flex place-items-center justify-between gap-5 bg-bgSecondaryColor py-2.5 px-5 rounded-full">
    <input
    ...
    <div className="flex cursor-pointer">
      <SendHorizontal type="submit" size={20} />
          ...
          <p className="text-gray-400 text-sm text-center p-3S">
